...
{facts}
Оценка надёжности по ончейн-данным: {verdict} (10 — максимальное доверие, 1 — почти наверняка ловушка)
...
5. Итог — два предложения: главное ЗА проект и главное ПРОТИВ, по фактам выше. Решение принимает читатель:
   НЕ пиши «брать», «не брать», «ждать», «рекомендую», не повторяй оценку риска и не ссылайся на «правила».
   Права команды и крупные кошельки у зрелого большого проекта — нормальное управление, не довод против.
   Никаких советов, сколько вкладывать.
